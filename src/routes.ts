...
routes.post(
  "/chat/create/user",
  verifyAuthenticated,
  addParticipantController.handle
);
routes.post(
  "/chat/message",
  verifyAuthenticated,
...
routes.post(
  "/order/update",
  verifyAuthenticated,
  updateOrderByIdController.handle
);
...
routes.get(
  "/users/list/order",
  verifyAuthenticated,
  listCustomerOrderController.handle
);
routes.get(
  "/users/list/order/all",
  verifyAuthenticated,
  listAllOrderController.handle
);
routes.get(
  "/users/list/category",
  verifyAuthenticated,
...
routes.get(
  "/chat/list/message",
  verifyAuthenticated,
  listChatMessageController.handle
);
